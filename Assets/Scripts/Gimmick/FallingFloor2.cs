...
public class FallingFloor2 : MonoBehaviour
{
    ...
    [SerializeField] private Material gold_mat;
    ...
    {
        if (!isTrigger && collider.gameObject.CompareTag("GoldBull") && !GameManager.I.isStart)
        {
            isTrigger = true; // プレイヤーが接触したら開始
            meshRenderer.material = gold_mat;
        }
    }
    ...
    {
        meshRenderer.material = normal_mat;
